...
//        boolean flag = this.service.saveOrUpdateCompany(CompanySaveReq);
...
////boolean flag = this.service.deleteCompany(CompanyDelReq);
...
//        List<Company> CompanyList = this.service.list(null);
//        if (CompanyList != null) {
